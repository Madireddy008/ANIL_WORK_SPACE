...
f=open('/workspaces/python-for-devops/AnilPythonPractice/Day-12/8.1.Filehandling-demo.py',mode='w')
f.write("#This is for Testing Python FileHandling Writing")
f.close()

print('PRINTING WRITTEN DATA USING MODE W:')
f=open('/workspaces/python-for-devops/AnilPythonPractice/Day-12/8.1.Filehandling-demo.py',mode='r')
print(f.read())
f.close()

print('APPENDING DATA USING MODE A:')
f=open('/workspaces/python-for-devops/AnilPythonPractice/Day-12/8.1.Filehandling-demo.py',mode='a')
