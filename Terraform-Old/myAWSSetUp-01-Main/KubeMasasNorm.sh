#!/bin/bash
# Install Updates, Upgrade and Kubernetes(Worked)
...
mkdir -p /home/ubuntu/.kube && sudo cp -i /etc/kubernetes/admin.conf /home/ubuntu/.kube/config && sudo chown ubuntu:ubuntu -R /home/ubuntu/.kube
